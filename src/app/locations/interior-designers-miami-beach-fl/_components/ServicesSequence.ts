...
export const SERVICES: SequenceService[] = [
  {
    ...
    category: "Whole home",
    description:
      "Whole interiors, whether the property is an apartment high in a tower, a house on one of the islands, or a residence lived in only part of the year. Furnishings, finishes, lighting, and art arrive in layers across the length of the project instead of all at once, which is the difference between a residence that looks collected and one that looks ordered.",
  ...
  },
  {
    ...
    category: "Renovation",
    description:
      "Renovations taken back to structure and carried to the last item on the punch list. On Miami Beach the first job is establishing what the building will actually permit, because risers, ceiling depths, and available electrical capacity in an older tower shape a plan far more than any reference image will. Where an association has to approve the work, or a historic exterior pulls the city in, those reviews get dates at the outset rather than a scramble later.",
  ...
  },
  {
    ...
    category: "New build",
    description:
      "Island lots are tight, neighbors are close, and finished floors sit high for flood elevation, which changes how you arrive at a house and how the ground floor meets the garden. Those things are settled with your architect in plan, before the shell goes up, because no amount of furnishing fixes an entry sequence or a sightline that was decided wrong on paper.",
  ...
  },
  {
    ...
    description:
      "Kitchens planned around how the household actually cooks and gathers. In a Miami Beach tower the constraints come first, since venting, gas, and plumbing locations are frequently fixed by the building, and a layout drawn without confirming them gets redrawn later. Storage, sightlines, and workflow are solved against those facts, then the cabinetry, stone, and appliances follow.",
  ...
  },
  {
    ...
    description:
      "Cabinetry and freestanding pieces drawn specifically for the room that will hold them. On this island the delivery route shapes a design almost as much as the brief does, since anything large has to clear a service elevator, a stair turn, or a narrow street off the causeway. That gets solved on paper, splitting a piece into sections where access demands it and detailing the joints so nothing about the seam registers once it is in place.",
