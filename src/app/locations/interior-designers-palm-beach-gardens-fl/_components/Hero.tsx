        ...
        <ScrollReveal>
          <div className="space-y-6 backdrop-blur-xs p-4">
            <h1 className="eyebrow text-cream-200 text-center">
              Palm Beach Gardens Interior Design Firm
            </h1>
            ...
            <h2 className="lg:text-[6rem] text-[2.25rem] text-[color-mix(in_oklab,var(--color-taupe-800)_var(--hero-mix,0%),white)] leading-none space-y-2 mb-6">
              ...
              <span className="block w-fit">nothing borrowed.</span>
            </h2>
            <p className="text-taupe-100 max-w-200">
              Sarvian Design Group is a full-service interior design firm
              working across Palm Beach Gardens on residential and commercial
              projects, from a single reworked room to a house drawn alongside
              its architect.
            </p>
            <ArrowButton2
              href="/projects"
