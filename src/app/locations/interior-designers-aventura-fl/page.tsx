  ...
  return (
    <main>
      ...
      <LocationEditorial
        ...
        paragraphs={[
          "Aventura lives vertically. Most of the city's best addresses are towers along Country Club Drive and the Intracoastal, where every residence arrives with the same developer finishes and a view doing all the work. As a full-service luxury interior design firm, that is usually where we start: stripping out the builder's anonymous palette and designing a home that belongs to the people in it — millwork drawn for the actual walls, stone chosen slab by slab, lighting planned for evenings on the fortieth floor rather than a sales-center rendering.",
          "Tower living also changes how a project runs. Association approvals, service-elevator reservations, work-hour limits, and sound attenuation standards all sit between the design and the finished room, so we plan the submission and its calendar into the project from the first meeting. The glass raises the standard on specification too: strong east and west light pours through these residences all day, and fabrics and finishes have to hold their depth through years of it. Considered layouts, custom built-ins, and easy transitions between rooms are what separate the best interior designers from the rest.",
