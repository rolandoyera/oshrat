  ...
  return (
    <main>
      ...
      <LocationEditorial
        ...
        paragraphs={[
          "Aventura lives vertically. Most of the city's best addresses are towers along Country Club Drive and the Intracoastal, where every residence arrives with the same developer finishes and a view doing all the work. As a full-service luxury interior design firm, that is usually where we start: stripping out the builder's anonymous palette and designing a home that belongs to the people in it. Millwork designed for the actual walls, stone chosen slab by slab, lighting planned for evenings on the fortieth floor rather than a sales-center rendering.",
