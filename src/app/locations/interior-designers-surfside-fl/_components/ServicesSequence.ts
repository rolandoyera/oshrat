...
// Surfside's services list, passed to the shared ServicesSequence.
...
export const SERVICES: SequenceService[] = [
  ...
  },
  {
    ...
    description:
      "Select commercial, hospitality, and community work where full-service design earns its keep. The sanctuary at The Shul on Collins Avenue in Surfside was designed this way — custom bronze, stone, and millwork specified in-house and followed through fabrication and installation. A room that serves hundreds of people every week demands the restraint of a private home and far more durability.",
