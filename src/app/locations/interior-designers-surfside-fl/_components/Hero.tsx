        ...
        <ScrollReveal className="w-full">
          <div className="space-y-6">
            ...
            <p className="text-taupe-100 max-w-200">
              Sarvian Design Group designs homes, commercial spaces, and
              community interiors in Surfside and along the South Florida coast
              — one studio carrying the work from the first floor plan through
              millwork, materials, and the day everything is installed.
            </p>
          </div>
        </ScrollReveal>
      </Container>
