        ...
        <ScrollReveal>
          <div className="space-y-6 backdrop-blur-xs p-4">
            <h1 className="eyebrow text-cream-200 text-center">
              West Palm Beach Interior Design Firm
            </h1>
            ...
            <h2 className="lg:text-[6rem] text-[2.25rem] text-[color-mix(in_oklab,var(--color-taupe-800)_var(--hero-mix,0%),white)] leading-none space-y-2 mb-6">
              ...
              <span className="block w-fit">the trend.</span>
            </h2>
            <p className="text-taupe-100 max-w-200">
              A luxury interior design firm working on both sides of West Palm
              Beach, from the historic houses of El Cid and Flamingo Park to the
              offices, showrooms, and tower residences downtown.
            </p>
            <ArrowButton2
              href="/projects"
              variant="primary"
